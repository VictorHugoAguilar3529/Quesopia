...
<h1 class="text-center">Modifica un Usuario</h1>
...
<div class="form-group text-left">
      ...
      <input type="text" name="id" id="id" class="form-control" required placeholder="Escriba el id del usuario"
...
<label for="primerNombre">* Primer Nombre:</label>
    ...
    <div class="form-group text-left">
      ...
      <input type="email" name="usuario" id="usuario" class="form-control" placeholder="Escriba su clave de acceso" required value='<?php isset($datos["data"]["usuario"])? print $datos["data"]["usuario"]:""; ?>'/>
    </div>
    ...
    <div class="form-group text-left">
      <input type="hidden" id="id_inv" name="id" value="<?php print $datos['data']['id_inv']; ?>"/>
