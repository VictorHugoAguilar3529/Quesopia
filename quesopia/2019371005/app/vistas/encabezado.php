...
<body>
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <a href="<?php print RUTA; ?>" class="navbar-brand">QUESOPIA</a>
    <div class="collapse navbar-collapse" id="menu">
    <?php if ($datos["menu"]) {
          print "<ul class='navbar-nav mr-auto mt-2 mt-lg-0'>";
      print "<li class='nav-item'>";
      print "<a href='".RUTA."Quesos' class='nav-link ";
      if(isset($datos["activo"]) && $datos["activo"]=="Quesos") print "active";
      print "'>Productos</a>";
      print "</li>";
      //
      print "<li class='nav-item'>";
      ...
      <input type="text" name="buscar" id="buscar" class="form-control" size="20" placeholder="buscar producto.">
      <button type="submit" class="btn btn-light"><i class="faa fa-search"></i></button>
    </form>
    <?php    }
    ...
    if($datos["admon"]){
        ...
        print "<li class='nav-item'>";
        print "<a href='".RUTA."admonInventario' class='nav-link'>Inventario</a>";
        print "</li>";
